  ...
  return (
    <div>
      <Router>
        <Switch>
          {/* PRIVATE */}
          <Route exact path={['/admin', '/test', '/nuevaventa', '/ventas', '/admin/productos', '/admin/usuarios', '/admin/productos/ingresar', '/admin/productos/editar', '/admin/usuarios/editarUsuario', '/ventas/ingresarVenta', '/ventas/editarVenta']}>
            <PrivateLayout>
              <Switch>
